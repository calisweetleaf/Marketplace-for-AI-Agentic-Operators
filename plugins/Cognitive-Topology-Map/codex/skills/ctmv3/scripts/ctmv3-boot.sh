#!/usr/bin/env bash
# ctmv3-boot.sh -- Codex-side wrapper for python3 -m ctmv3 boot
# Runs the discovery sequence and determines cold vs warm entry branch.
# Usage: ctmv3-boot.sh [PROJECT_ROOT] [--json] [additional args...]
set -euo pipefail
