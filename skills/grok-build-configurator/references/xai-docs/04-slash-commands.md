...
Run a prompt on a recurring interval. Say how often it should run in whatever phrasing is natural — compact (`30m`), unit words (`1 hour`), or trailing (`… every 2 days`). If you omit the interval you'll be asked how often to run it; there is no silent default.
