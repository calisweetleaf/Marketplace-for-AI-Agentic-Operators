...
| Global | `~/.claude/settings.json` | Always | Claude Code compatibility (configurable) |
...
| Project | `<project>/.claude/settings.json` | Requires trust | Claude compatibility (configurable) |
