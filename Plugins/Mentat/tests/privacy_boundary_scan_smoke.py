#!/usr/bin/env python3
"""Regression smoke test for Mentat's release privacy scanner."""
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="mentat-privacy-smoke-") as tmp:
        root = Path(tmp)
        ...
        allowed = write_case(
            root,
            "allowed.md",
            "Known package root: " + "/" + "home/daeron/Projects/Modern-ML/Plugins/Mentat\n"
