#!/usr/bin/env python3
"""Scan CTMv3 release-candidate text for private boundary leaks.
...
DEFAULT_ALLOWED_PATH_PREFIXES = (
    ...
    "/home/daeron/.codex/skills/ctmv3",
    "/home/daeron/.claude/plugins/ctmv3",
    "/home/daeron/.opencode/skills/ctmv3",
    "/home/example",
    "/home/user",
    "/home/you",
)
...
def main(argv: list[str]) -> int:
    ...
    if findings:
        print("CTMv3 privacy boundary scan: FAIL")
        for finding in findings:
            print(f"- {finding}")
        return 1

    print("CTMv3 privacy boundary scan: PASS")
    print(f"root={root}")
